...
public class AuctionController {
    ...
    @GetMapping("/{id}")
    public String showAuctionDetails(@PathVariable Long id, @AuthenticationPrincipal User user, Model model) {
        Auction auction = auctionService.getAuctionById(id);
        model.addAttribute("auction", auction);
        model.addAttribute("isOwner", auction.getSeller().getId().equals(user.getId()));
